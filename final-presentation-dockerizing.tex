...
\frame{
	\frametitle{A Docker example: Virtuoso 7 Docker}
	Virtuoso is a triple store for managing RDF data. (hier kommen noch grundlagen ein Ausschnitt aus dem Dockerfile) 
}
