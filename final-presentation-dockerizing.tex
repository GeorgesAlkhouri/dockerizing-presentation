...
\frame{
	...
	Wants to improve setup of linked data environments and make the replacement of components more easier 
	\vspace{\baselineskip}
...
\frame{
	...
	Dockerizing application sits on top of Docker Compose
	\vspace{\baselineskip}
